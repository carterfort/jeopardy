...
exports.default = {
    ...
    methods: {
        ...
        fetchCategoryWithID: function fetchCategoryWithID(id) {
            var vm = this;
        ...
        randomCategories: function randomCategories() {
            var numbers = [];
            ...
            while (numbers.length < 6 && failsafe < 10) {
                ...
                if (numbers.filter(function (number) {
        ...
        fetchCluesForCategory: function fetchCluesForCategory(category) {
            var vm = this;
        ...
        askQuestionForClue: function askQuestionForClue(clue) {
            if (clue.answered) {
                return;
            }
...
var _Game = require('./components/Game.vue');
